...
<script runat="server">
    ...
    private DataTable GetData()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT CONVERT(VARCHAR, DateIn, 101) AS DateIn, ClockIn, ' ' as ' ', CONVERT(VARCHAR, DateOut, 101) AS DateOut, ClockOut FROM Log_Table WHERE EmployeeID = 'nancy.worden' AND DateOut BETWEEN '4/1/2018' AND '4/30/2018'"))
            {
